...
public class appointment_testcase extends AppTestBase
{
	...
	@Test(priority = 7, groups = { "sanity" }, description = "Precondition: Create an appointment via the API\n"
	...
	@Test(priority = 8, groups = {"sanity" }, dependsOnMethods = "createAppointmentTest", description = "Precondition: An appointment must be created successfully.\n"
